...
# suppress non-fatal known warnings from dependencies
...
#Create the agent core app instance
...
emb = model.encode(["hello world", "another sentence"])
print(type(emb), getattr(emb, "shape", None))  # should print a numpy array shape (2, 384)
